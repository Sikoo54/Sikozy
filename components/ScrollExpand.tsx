      ...
      <div ref={trackRef} className="relative w-full">
        ...
        >
          ...
          >
            ...
            <div
              ref={scrimRef}
              className="pointer-events-none absolute inset-0 opacity-0 bg-[linear-gradient(to_top,rgba(0,0,0,0.75),rgba(0,0,0,0.1)_45%,rgba(0,0,0,0.35))]"
            />
            {children ? (
              <div
                ref={overlayRef}
          ...
          {title ? (
            <div
              ...
              className={`absolute inset-0 flex items-center justify-center px-[6%] text-center [will-change:opacity,transform] ${
                titleClassName ||
                "m-0 font-bold leading-none tracking-[-0.03em] text-white [font-size:var(--se-title-size)] [text-shadow:0_2px_24px_rgba(0,0,0,0.45)]"
              }`}
            >
              {title}
            </div>
